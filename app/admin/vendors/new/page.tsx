      ...
      <div className="lx-page lx-console flex items-start justify-center px-5 py-12 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-md space-y-4">
          <div className="rounded-3xl border border-green-500/30 bg-green-500/10 p-6">
            <p className="text-lg font-semibold text-white">Vendor record created</p>
            ...
            <p className="mt-3 text-sm text-white/60">
              This account is pending review and will not go live until inspection and approval are complete.
            </p>
            <div className="mt-4">
  ...
  return (
    <div className="lx-page lx-console px-5 py-10 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-md">
        <PageHeader
          title="Add Vendor"
          subtitle="A temporary PIN will be generated and the vendor will stay pending until approval."
          badge="Admin"
        />
...
function Field({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <label className="block">
      <span className="lx-mono mb-2 block">{label}</span>
      {children}
    </label>
  )
}
