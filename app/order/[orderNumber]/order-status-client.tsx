        ...
        {order.riders && ['RIDER_ASSIGNED', 'PICKED_UP', 'DELIVERED'].includes(order.status) && (
          <div className="glass-thin p-4 flex items-center gap-4 lx-scale-in">
            ...
            <div className="flex gap-1.5 shrink-0">
              <a href={`tel:${order.riders.call_phone ?? order.riders.phone}`} className="w-11 h-11 rounded-full flex items-center justify-center transition-transform active:scale-90" style={{ background: 'rgba(34,197,94,0.15)', color: '#22c55e' }} aria-label="Call rider">
              ...
              <a href={`sms:${order.riders.call_phone ?? order.riders.phone}`} className="w-11 h-11 rounded-full flex items-center justify-center transition-transform active:scale-90" style={{ background: 'rgba(96,165,250,0.15)', color: '#60a5fa' }} aria-label="Text rider (SMS)">
              ...
              <a href={`https://wa.me/${order.riders.phone.replace('+', '')}`} target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-full flex items-center justify-center transition-transform active:scale-90" style={{ background: 'rgba(34,197,94,0.15)', color: '#22c55e' }} aria-label="WhatsApp rider">
