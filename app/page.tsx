...
export default async function HomePage() {
  ...
  return (
    <main className="min-h-dvh pb-24" style={{ background: '#0A0A0B' }}>
      {/* Header */}
      <div className="sticky top-0 z-40 px-4 py-3 border-b border-white/8"
        ...
        <div className="max-w-lg mx-auto flex items-center justify-between">
          ...
          <a href="/profile" className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center" aria-label="Profile">
      ...
      <div className="max-w-lg mx-auto px-4 py-4 space-y-5">
        ...
        {/* Client component handles search, categories, realtime */}
