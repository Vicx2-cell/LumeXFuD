    ...
    <main className="min-h-dvh pb-28" style={{ background: '#0A0A0B', color: '#fff' }}>
      ...
      <div className="sticky top-0 z-10 border-b border-white/8 px-4 py-3"
        ...
        <div className="max-w-lg mx-auto flex items-center gap-3">
          <button onClick={() => router.push('/profile')} aria-label="Back to profile"
            className="w-11 h-11 rounded-full flex items-center justify-center shrink-0 active:opacity-70"
      ...
      {topupOpen && (
        <div className="fixed inset-0 z-50 flex items-end justify-center">
          <div
            className="absolute inset-0 bg-black/70 lx-scrim"
            onClick={() => setTopupOpen(false)}
          />
          <div className="lx-sheet relative w-full sm:max-w-md sm:mb-4 rounded-t-3xl sm:rounded-3xl p-6 pb-[max(1.5rem,env(safe-area-inset-bottom))] max-h-[90dvh] overflow-y-auto"
            ...
            <div className="relative mb-1">
              ...
              <input
                ...
                autoComplete="off"
                enterKeyHint="done"
                aria-label="Custom top-up amount in naira"
                ...
                className="w-full pl-8 pr-4 py-3.5 rounded-xl text-base outline-none"
                style={{
            ...
            <button
              ...
              className="w-full py-4 rounded-xl font-semibold text-base transition-opacity disabled:opacity-40 mt-1 active:scale-[0.98]"
              style={{ background: '#F5A623', color: '#000' }}
            >
