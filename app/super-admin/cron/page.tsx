              ...
              >
                <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {j.money && (
                        <span className="text-[10px] uppercase tracking-wider px-1.5 py-0.5 rounded"
                          style={{ background: 'rgba(245,166,35,0.15)', color: '#F5A623' }}>money</span>
                      )}
                      {j.overdue && (
                        <span className="text-[10px] uppercase tracking-wider px-1.5 py-0.5 rounded"
                          style={{ background: 'rgba(239,68,68,0.18)', color: '#FCA5A5' }}>overdue</span>
                      )}
                    </div>
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-xl px-3 py-2 text-xs font-semibold text-black disabled:opacity-50"
