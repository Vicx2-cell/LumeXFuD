...
export const FEATURES: FeatureDef[] = [
  ...
  { key: 'customer_virtual_accounts', label: 'Customer Paystack virtual accounts', description: 'Allow eligible, consenting registered customers to request a Paystack Dedicated Virtual Account. This never creates or exposes a LumeX stored-value balance.', default: false, enforced: true },
