...
export const FEATURES: FeatureDef[] = [
  ...
  { key: 'customer_wallet_enabled', label: 'Customer LumeX Wallet balance', description: 'Allow customers to spend confirmed LumeX Wallet balance at checkout. Funding is through the Paystack-backed LumeX Wallet account, not the retired top-up screen.', default: false, enforced: true },
  { key: 'customer_virtual_accounts', label: 'Customer LumeX Wallet accounts', description: 'Allow eligible customers to request a Paystack Dedicated Virtual Account that funds their LumeX Wallet balance for checkout.', default: false, enforced: true },
