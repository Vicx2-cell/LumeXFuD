...
const ENTRIES: Entry[] = [
  ...
  { path: 'app/api/super-admin/security-incidents/route', method: 'GET', allow: SUPER },
  { path: 'app/api/super-admin/security-incidents/route', method: 'POST', allow: SUPER },
  { path: 'app/api/super-admin/security-incidents/[id]/export/route', method: 'GET', allow: SUPER },
